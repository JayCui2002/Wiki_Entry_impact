...
from .endpoints import auth, contributors, analytics, wikipedia, analysis_sessions
...
api_router.include_router(analysis_sessions.router, prefix="/analysis-sessions", tags=["Analysis Sessions"]) 